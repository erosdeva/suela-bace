      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 order-2 lg:order-1">
            <div className="bg-neutral-950 p-6 md:p-8 rounded-2xl border border-neutral-900 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-mono text-neutral-300 font-bold">Cultural Exploration</h4>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-mono text-neutral-300 font-bold">Resilience & Recovery</h4>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-mono text-neutral-300 font-bold">Oral Traditions</h4>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">
            ...
            {/* In-text pull quote */}
            <div className="p-6 bg-red-950/20 border border-red-900/30 rounded-2xl relative shadow-md">
              <Quote className="w-8 h-8 text-red-600/30 absolute -top-4 -left-2" />
              <p className="text-sm font-serif italic text-neutral-200 leading-relaxed">
          ...
          <div className="lg:col-span-7 bg-neutral-950 border border-neutral-800/60 p-6 md:p-10 rounded-2xl shadow-xl order-1 lg:order-2 space-y-6">
